...
import { Code, Sparkles, Zap, Layers, ExternalLink, Github } from 'lucide-react';
  ...
  const projects = [
     {
      ...
      category: "fullstack",
      description: "WebSocket-based chat platform with end-to-end encryption functionality and seamless UI",
    ...
    },
    {
      ...
      category: "fullstack",
      description: "My Final year Project AI-based Attendance Monitoring (Online Classroom Attention Tracker - OCAT).",
   ...
   
    {
      ...
      category: "fullstack",
      description: "A role based store rating app where user can add and rate store according to role",
    ...
    },
    {
      ...
      title: "Notes RESTapi ",
      category: "backend",
      description: "A backend service built to create, retrieve, update, and delete (CRUD) notes via standard HTTP requests.",
      tech: ["Express.js"],
    ...
    },
     {
      ...
      title: "Hungman Game",
      category: "frontend",
      description: "Classic word-guessing game where the player tries to reveal a hidden word by guessing letters before running out of attempts.",
      tech: ["React.js, "],
      color: "from-yellow-500 to-orange-500",
      icon: <Sparkles className="w-6 h-6" />
    },
     {
      ...
      title: "Todo list app",
      category: "frontend",
      description: "A react project to create, manage, and track personal or professional tasks, featuring options to mark items as complete..",
      tech: ["React.js"],
      color: "from-yellow-500 to-orange-500",
      icon: <Sparkles className="w-6 h-6" />
    }
      ...
      <div className="pt-32 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-slate-400 max-w-2xl">
            A showcase of my work in building efficient, dynamic, and user-friendly web applications.
          </p>
        </div>
      </div>
              ...
              >
                ...
                <div className="relative p-6">
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-slate-700/50 hover:bg-slate-700 rounded-lg text-sm text-white transition-colors">
                      <ExternalLink className="w-4 h-4" />
                      Live Demo
                    </button>
                    <button className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-700/50 hover:bg-slate-700 rounded-lg text-sm text-white transition-colors">
                ...
                <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none`}>
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${project.color} blur-xl opacity-20`} />
                </div>
              </div>
            ))}
          </div>
